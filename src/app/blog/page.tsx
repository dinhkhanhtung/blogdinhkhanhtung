    ...
    if (pParts.length > 3) {
      ...
      if (inlinePost) {
        const inlineHtml = `
          ...
          <div class="my-10 p-6 bg-slate-50 border border-slate-200 border-l-4 border-l-[#15803d] rounded-r-lg shadow-sm not-prose group cursor-pointer hover:shadow-md transition-all" onclick="window.location.href='/blog?post=${inlinePost.slug}'">
            <div class="text-xs font-bold text-[#15803d] uppercase tracking-wider mb-2 flex items-center gap-2">
            ...
            <a href="/blog?post=${inlinePost.slug}" class="text-lg font-heading font-bold text-slate-900 group-hover:text-[#15803d] transition-colors block">
              ${inlinePost.title}
            </a>
          </div>
        `;
      ...
      <div className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-8 bg-white rounded-2xl border border-slate-200 p-4 sm:p-6 md:p-10 shadow-sm">
            ...
            <div className="w-full aspect-[16/9] md:aspect-[21/9] rounded-lg overflow-hidden relative shadow-sm border border-slate-200 mb-10">
              ...
              <div className="absolute top-4 left-4 bg-white/95 backdrop-blur-sm text-[#15803d] px-4 py-1.5 rounded-full text-xs font-bold uppercase tracking-widest shadow-[0_2px_10px_rgba(0,0,0,0.1)] border border-white/50">
                {post.category}
              </div>
            </div>
          ...
          {toc.length > 0 && (
            <div className="bg-slate-50 border border-slate-200 rounded-lg p-6 mb-10">
              ...
              <ul className="space-y-3 text-base font-semibold text-[#15803d]">
                {toc.map((item) => (
          ...
          <article
            className="prose lg:prose-lg max-w-none text-lg text-slate-700 leading-[1.85]
              ...
              prose-h3:text-2xl prose-h3:mt-10 prose-h3:mb-5 prose-h3:border-l-4 prose-h3:border-[#15803d] prose-h3:pl-4
              prose-p:mb-6 prose-p:text-[1.125rem] prose-p:text-left
              prose-a:text-[#15803d] prose-a:font-bold hover:prose-a:underline
          ...
          <div className="mt-16 p-8 bg-slate-50 border border-slate-200 rounded-lg flex flex-col md:flex-row items-center gap-6 text-center md:text-left">
            ...
            <div>
              ...
              <a href="https://zalo.me/0982581222" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 text-white bg-[#15803d] px-4 py-2 rounded-lg text-sm font-bold hover:bg-[#166534] transition-colors shadow-sm">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
              {allPosts
                ...
                <a key={related.id} href={`/blog?post=${related.slug}`} className="group block bg-slate-50 border border-slate-200 rounded-lg overflow-hidden hover:shadow-md transition-shadow">
                  ...
                  <div className="p-4">
                    <div className="text-xs font-bold text-[#15803d] mb-2 uppercase tracking-wider">{related.category}</div>
                    <h4 className="text-base font-bold text-slate-900 group-hover:text-[#15803d] line-clamp-2 transition-colors">
                      {related.title}
                    </h4>
                  </div>
                </a>
        ...
        <div className="lg:col-span-4 space-y-6 sticky top-24">
          <div className="bg-white border border-slate-200 rounded-lg p-6 shadow-sm">
            <h4 className="text-lg font-heading font-bold text-slate-900 border-b-2 border-[#15803d] pb-2 mb-5 inline-block">
              Bài viết mới nhất
            </h4>
              ...
              {latestPosts.map((lPost) => (
                <a key={lPost.id} href={`/blog?post=${lPost.slug}`} className="flex gap-4 group">
                  ...
                  <div className="flex-1 min-w-0">
                    <h5 className="text-sm font-bold text-slate-800 leading-snug group-hover:text-[#15803d] transition-colors line-clamp-2 mb-1">
                      {lPost.title}
                    </h5>
          ...
          <div className="bg-[#15803d] text-white rounded-lg p-8 text-center shadow-md relative overflow-hidden">
            ...
            <div className="space-y-3 relative z-10">
              <a href="tel:0982581222" className="block w-full bg-white text-[#15803d] py-3 rounded-lg font-bold hover:bg-slate-100 transition-colors shadow-sm">
